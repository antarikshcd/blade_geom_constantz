...
filename = './input_surfaces/KB6_surf_1000by1000' #KB6_surface_S500_C100
...
span_low = 9 # span to be calculated
span_high = 10 # upper limit excluded
...
sin = np.linspace(0, Ns_orig - 1, Ns, endpoint = False)
...
if span_high - span_low == 1:    
    ...
    np.save('KB6_surf_par_s%ic%i_v4.npy'%(Ns, n_points), surface_new)